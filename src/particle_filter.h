...
struct Particle {
	...
	std::vector<double> tx_global_x;
	std::vector<double> tx_global_y;
};
...
public:
	...
	void writeBest(Particle best, std::vector<LandmarkObs> noisy_observations, std::string filename, int time_step);
